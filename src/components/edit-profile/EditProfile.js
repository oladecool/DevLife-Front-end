...
class CreateProfile extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.profile.profile) {
            ...
            //If profile field deosn't exist, make empty string
            ...
            profile.social = !isEmpty(profile.social.twitter) ? profile.social.twitter : '';
                    ...
                    <div className="row">
                        ...
                        <Link to="/dashboard" className="btn btn-light">
                          Go Back
                            ...
                            <h1 className="display-4 text-center"> Edit Your Profile
                            </h1>
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <TextFieldGroup
                                    ...
                                    onChange={this.onChange}
                                    error={errors.skills}
                                    info="Please comma seperated values (e.g HTML,CSS,JAVASCRIPT,PHP)"
                                />
                                <TextFieldGroup
                                    ...
                                    info="If want your latest repos and github link, include your username"
                                />
                                <TextAreaFieldGroup
